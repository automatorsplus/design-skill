...
//
// Four independent axes compose a StylePreset at runtime:
//   FONT_STYLES   — typeface / font family
//   SURFACES      — background + text neutrals (no pop color)
//   ACCENTS       — the pop color used for highlighted words
//   composePreset — merges font + surface + accent + purpose into StylePreset
//
